 ...
 * @note 顺序消费案例
 */
public class GlobleOrderConsumer {

    public static void main(String[] args) throws MQClientException {
        // 实例化消费者，并指定组名
        DefaultMQPushConsumer consumer = new DefaultMQPushConsumer("gloable_group");

        // 指定NameSrv地址信息
        consumer.setNamesrvAddr("192.168.111.222:9876");

        // 订阅主题
        consumer.subscribe("topic_gloable_test_1", "*");
...
//                        System.out.println(Thread.currentThread().getName() +  ",topic: " + topic + ", tags：" + tags + ", msg: " + msgBody + ", queueId: " + queueId);
//                    }
//                } catch (Exception e) {
//                    e.printStackTrace();
