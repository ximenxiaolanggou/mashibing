package top.damoncai.quickstart;
...
public class Consumer_assign {
    ...
    public void before() {
        ...
        //订阅Topic开头的消息队列
        consumer.assign(Arrays.asList(new TopicPartition("topic02",0)));

        //指定消费位置
        //起始
//        consumer.seekToBeginning(Arrays.asList(new TopicPartition("topic02",0)));
        //指定
        consumer.seek(new TopicPartition("topic02",0),1);
    }
